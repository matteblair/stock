...
Framebuffer::Framebuffer(uint32_t width, uint32_t height, Options options)
    : m_colorTexture(width, height, nullptr, 0, getColorBufferOptions(options)),
    ...
    if (status != GL_FRAMEBUFFER_COMPLETE) {
        ...
        switch (status) {
            case GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT:
                Log::e("Error creating framebuffer: GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT"); break;
            case GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:
                Log::e("Error creating framebuffer: GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT"); break;
            case GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS:
                Log::e("Error creating framebuffer: GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS"); break;
            case GL_FRAMEBUFFER_UNSUPPORTED:
                Log::e("Error creating framebuffer: GL_FRAMEBUFFER_UNSUPPORTED"); break;
            default:
                Log::e("Error creating framebuffer: Unrecognized error."); break;
        }
